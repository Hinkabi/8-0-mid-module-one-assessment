...
function getTotalCount(animals) {
  ...
  for(let i=0;i<animals.length;i++){
    totalOfAnimals+= animals[i].count
  }if(totalOfAnimals >0){
...
function getMostCommonAnimal(animals) {
  ...
  for(let i=0; i<animals.length;i++){
    ...
    if(count > animals[0].count){
    objOfAnimal = animals[i];
    }
